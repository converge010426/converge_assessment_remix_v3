export function installHeroFinalFix(): void {
  ...
  const run = () => {
    ...
    overlay.innerHTML = `
      ...
      <!-- Replace only the old ENNEAGRAM panel. -->
      ...
      <!-- Replace only the obsolete questionnaire wording. -->
      ...
      <!-- Remove only the obsolete price/description interiors. Headers and delivery bands remain untouched. -->
      ...
      <!-- Replace only the obsolete bottom-left value claim. -->
